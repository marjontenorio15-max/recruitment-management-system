...
<body>
	    ...
	    <div class="row row-height">
	        <div class="col-xl-4 col-lg-4 content-left">
	            <div class="content-left-wrapper">
	                <a href="{{route('front-page')}}" id="logo"><img src="{{asset('assets/img/Rms.png')}}" alt="" width="45" height="45"></a>
	                <div id="social">
	                    <ul>
	                ...
	                <div class="copy">© 2022 Recruitment Management System</div>
	            </div>
    ...
    <script src="{{asset('assets/js/func_3.js')}}"></script>
</body>
</html>
