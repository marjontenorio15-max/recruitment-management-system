            ...
            <div class="row">
                <div class="col-3">
                    <div class="form-group shadow">
                        ...
                        <input class="form-control" onkeyup="myFunctionJobTitle()" id="myInputJobTitle"
                ...
                <div class="col-3">
                    <div class="form-group shadow">
                        ...
                        <input class="form-control" onkeyup="myFunctionCompany()" id="myInputCompany"
                ...
                <div class="col-3">
                    <div class="form-group shadow">
                        ...
                        <input class="form-control" onkeyup="myFunctionCity()" id="myInputCity"
        ...
        <div class="table-responsive">
            ...
            @php
                $vacancies = DB::table('tbl_job_list')->select('tbl_job_list.id as id','title', 'company_id',
                    'location', 'no_of_employee', 'salary', 'sex', 'work_exp', 'job_desc',
                     ...
                     ->orderBy('tbl_job_list.created_at', 'desc')->simplePaginate(10);
